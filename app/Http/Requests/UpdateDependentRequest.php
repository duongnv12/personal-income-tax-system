...
class UpdateDependentRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        // Và đảm bảo người dùng đang sửa người phụ thuộc của chính họ
        return Auth::check() && $this->route('dependent')->user_id === Auth::id();
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'tax_code' => [
                ...
                'string',
                'max:255',
                Rule::unique('dependents')->ignore($this->route('dependent')->id), // Bỏ qua chính bản ghi đang sửa
            ],
