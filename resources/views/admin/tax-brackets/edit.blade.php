            ...
            <div
                ...
                <div class="p-6 text-gray-900"> {{-- Bỏ sm:p-8 --}}
                    <h3 class="text-2xl font-bold text-gray-800 mb-6 text-center border-b pb-4"> {{-- font-bold,
                        border-b pb-4 --}}
                        <i class="fa-solid fa-pen-to-square mr-2 text-orange-600"></i> Chỉnh sửa Bậc Thuế Lũy tiến {{--
                        Thêm icon --}}
                    </h3>
                    <form method="POST" action="{{ route('admin.tax-brackets.update', $taxBracket) }}">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <x-text-input id="level" name="level" type="number"
                                    ...
                                    :value="old('level', $taxBracket->level)" required autofocus /> {{-- mt-1, text-sm
                                --}}
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="income_from" name="income_from" type="text"
                                    class="mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition duration-150 ease-in-out text-sm"
                                    :value="old('income_from', number_format($taxBracket->income_from ?? ''))"
                                    required />
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="income_to" name="income_to" type="text"
                                    class="mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition duration-150 ease-in-out text-sm"
                                    :value="old('income_to', number_format($taxBracket->income_to ?? ''))" />
                                <x-input-error class="mt-2 text-sm text-red-600"
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="tax_rate" name="tax_rate" type="text"
                                    class="mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 transition duration-150 ease-in-out text-sm"
                                    :value="old('tax_rate', $taxBracket->tax_rate * 100)" required />
                        ...
                        <div class="flex items-center justify-end mt-8">
                            ...
                            <x-primary-button
                                ...
                                {{-- px-5 py-2, shadow-md --}}
                                <i class="fa-solid fa-save mr-2"></i> {{ __('Cập nhật') }} {{-- Thay icon SVG bằng Font
                                Awesome --}}
                            </x-primary-button>
                        </div>
                    </form>
